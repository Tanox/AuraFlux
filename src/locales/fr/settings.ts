...
export const settings = {
  ...
  showPlaybackTab: "Onglet de Lecture",
  showStudioTab: "Onglet Studio",
  language: "Langue",
  region: "Région",
  ...
  modes: {
    ...
    [VisualizerMode.SILK_WAVE]: "Soie Luminée",
  ...
  modeDescriptions: {
    ...
    [VisualizerMode.DIGITAL_GRID]: "Une grille numérique 3D immersive, réagissant avec des pulsations de lumière.",
    [VisualizerMode.SILK_WAVE]: "Des rubans fluides et lumineux qui ondulent avec l'énergie audio.",
    [VisualizerMode.OCEAN_WAVE]: "Un terrain de vagues stylisé, visualisant l'histoire audio.",
    [VisualizerMode.TUNNEL]: "Tunnel géométrique pulsant créant une sensation de vitesse de distorsion.",
    [VisualizerMode.LASERS]: "Des rayons laser vifs et vibrants qui coupent l'espace visuel.",
    [VisualizerMode.WAVEFORM]: "Des formes d'onde abstraites créant des rubans spectraux à l'écran.",
