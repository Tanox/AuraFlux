...
export const settings = {
  ...
  modes: {
    ...
    [VisualizerMode.WAVES]: "Ondes",
    [VisualizerMode.RINGS]: "Anneaux",
    [VisualizerMode.GLOW]: "Lueur",
    [VisualizerMode.FLOW]: "Flux",
  },
  modeDescriptions: {
    ...
    [VisualizerMode.WAVES]: "Ondes fluides et ondulantes qui s'adaptent à l'énergie audio.",
    [VisualizerMode.RINGS]: "Anneaux concentriques qui s'étendent et se contractent avec les pics audio.",
    [VisualizerMode.GLOW]: "Lueur éclatante qui réagit aux changements d'intensité audio.",
    [VisualizerMode.FLOW]: "Flux organique de particules qui suivent les contours de la musique.",
  },
  lyricsStyles: {
