export const helpModal = {
  ...
  gestureItems: {
    ...
    longPress: "Pressionar Longo: Alternar Info IA / Letra",
  },
  projectInfoTitle: "Nossa Missão",
  aboutDescription: "Aura Flux torna visível o invisível. Fundido entre arte generativa, processamento de áudio em tempo real e IA avançada, nossa missão é transformar a experiência auditiva em uma jornada visual personalizada e rica.",
  techStackTitle: "Tecnologias Principais",};
