...
export const settings = {
  ...
  modeDescriptions: {
    ...
    [VisualizerMode.RINGS]: "Concentric rings that expand and contract with audio peaks.",
    [VisualizerMode.FLUID_CURVES]: "Smooth, flowing curves that change and transform with sound.",
    [VisualizerMode.RIPPLES]: "Expanding circular waves, emanating from the center on beats.",
    [VisualizerMode.SPIRAL]: "A logarithmic particle spiral, reacting to frequency changes.",
