...
export const settings = {
  ...
  modes: {
    ...
    [VisualizerMode.LASERS]: "Feixes Laser",
  ...
  modeDescriptions: {
    ...
    [VisualizerMode.DIGITAL_GRID]: "Uma grade digital 3D imersiva, reagindo with pulsos de luz.",
    ...
    [VisualizerMode.LASERS]: "Feixes laser nítidos e vibrantes cortando o espaço visual.",
    ...
    [VisualizerMode.VORTEX]: "Um vórtice giratório de luz e partículas que distorce o espaço ao seu redor.",
  },
  lyricsStyles: {
