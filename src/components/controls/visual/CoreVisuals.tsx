...
// src/components/controls/visual/CoreVisuals.tsx v2.3.11
                    ...
                    <>
                        ...
                        <div className="space-y-2">
                            ...
                            <SegmentedControl 
                                ...
                                options={[{id:'low', label: 'Low'}, {id:'med', label: 'Medium'}, {id:'high', label: 'High'}]}
