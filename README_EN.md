...
### AI-Powered 3D Music Visualizer & Synesthesia Engine (v2.3.10)

[Live Demo](https://aura.ewuse.com/) | [简体中文](./README.md) | [Documentation](./openspec/)
...
- **Data Portability:** Export precisely tuned settings as JSON files and share your presets in the community.

*Note: PWA features have been temporarily disabled for environmental compatibility in this version.*
