...
- **Documentation Consistency**: Verified all documentation version numbers are synchronized at v2.3.11
...
- **OpenSpec Sync**: Updated all documentation to v2.3.11
...
- **Version Synchronization**: Updated all project files to version v2.3.11
...
- **Version Update**: All specification documents updated to v2.3.11
...
### 🎉 Version Update & Documentation Synchronization
- **Version Synchronization**: Updated all project files to version v2.3.11
- **Multi-language Support**: Enhanced multi-language support structure, resolved translation validation issues
- **Testing**: Verified stability and optimization of all modules
- **Documentation**: Synchronized all source documentation (openspec)
- **Code Audit**: Standardized version numbers for all modules to v2.3.11
...
- **Bars Mode**: Implemented height-based color variation from green (low) to red (high)

## [v2.2.16]
### 🐛 Bug Fixes
- **Portuguese Localization**: Fixed character encoding issues in Portuguese language file, correcting 'Intelig锚ncia' and 'Sinest茅sica' display
...
## [v2.2.14]
### ✨Visualization Enhancements
- **Plasma Mode**: Dramatically increased glow effects by 10x, creating full-screen鍏夋檿 coverage with enhanced particle trails and background illumination
...
### 🚀 UI Improvements
- **Settings Panel**: Moved the settings options UI from the top to the bottom of the canvas, positioned above the mini toolbar to avoid閬尅 (obstruction)
...
## [v2.2.4]
### ✨Visualization Enhancements
- **Ocean Mode**: Further reduced curve lines height to 10% of original and renamed to "Ocean Wave" (海浪)
- **Localization**: Updated all translation files to use the new name "Ocean Wave" for Ocean Wave mode
