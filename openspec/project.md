...
**项目名称**: Aura Flux
**版本**: v1.9.88
**描述**: 一个基于 Next.js 15+ 和 Three.js 构建的高级 AI 音乐可视化应用。

## 技术栈
- **框架**: Next.js 15+ (App Router)
- **UI 样式**: Tailwind CSS v4
- **3D 渲染**: Three.js + React Three Fiber
- **AI 集成**: Google Gemini API (v3-flash-preview)
- **语言**: TypeScript

## 核心功能
1. **基础架构**: 搭建了 Next.js 15+ 基础结构。
...
4. **鲁棒性 (Robustness)**: 
   ...
   - 实现了版本更新检测 (`useVersionCheck`)，提示用户刷新以获取最新功能，支持自动消失（10秒）及顶部弹出位置。
...
## 开发规范
- 所有代码文件头部必须包含文件名与统一版本号注释（如 `v1.9.88`）。
- 页面容器需添加语义化 `id` 便于调试。
