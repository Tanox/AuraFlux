<!-- openspec/01_core_architecture.md v2.3.1 -->
# 核心架构规范
...
```tsx
// useAppState.ts 核心结构
// File: src/hooks/useAppState.ts | Version: v2.3.0
...
// File: src/hooks/useVisualsState.ts | Version: v2.3.0
import { useState, useCallback, useMemo } from 'react';
...
```tsx
// types/index.ts 核心结构
// File: src/types/index.ts | Version: v2.3.0
