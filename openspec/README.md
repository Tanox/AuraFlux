...
> **Note:** 最新项目文档已迁移至 `docs/` 目录。请参阅 [Architecture](../docs/ARCHITECTURE.md) 与 [API Documentation](../docs/API.md)。

## 核心规范索引 (v1.10.6 Standard)
...
---
*Aura Flux Project Specification - Final Audit v1.9.73*