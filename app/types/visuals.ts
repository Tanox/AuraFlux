// File: app/types/visuals.ts | Version: v1.9.67
...
export interface IVisualizerRenderer {
  ...
  draw(ctx: RenderContext, data: Uint8Array, width: number, height: number, colors: string[], settings: VisualizerSettings, rotation: number, beat: boolean, dataR?: Uint8Array): void;
  cleanup?(): void;
}
