// File: app/components/controls/Controls.tsx | Version: v1.9.72
      ...
      >
        <div className="max-w-6xl mx-auto p-4 pt-6">
          <div className="bg-white/90 dark:bg-[#0a0a0c]/90 backdrop-blur-2xl border border-black/10 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-fade-in-down">
            <div className="flex justify-center p-2 bg-black/[0.02] dark:bg-white/[0.02] border-b border-black/5 dark:border-white/5 overflow-x-auto no-scrollbar">
              {TABS.map(tab => (
                <button
                  key={tab.id}
            ...
            <div className="p-4 overflow-y-auto custom-scrollbar max-h-[calc(100vh-200px)]">
              {ActiveComponent}
            </div>
          </div>
        </div>
