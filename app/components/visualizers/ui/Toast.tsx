...
export const Toast: React.FC<ToastProps> = ({ message, type = 'success', onClose }) => {
  ...
  return (
    <div id="toast-notification" className={`fixed bottom-24 left-1/2 -translate-x-1/2 z-[9999] transition-all duration-300 transform ${visible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-95 pointer-events-none'}`}>
