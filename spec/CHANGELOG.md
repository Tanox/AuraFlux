...
- **Bars Mode**: Implemented height-based color鍙樺寲 from green (low) to red (high)
...
## [v2.2.4]
### 鉁?Visualization Enhancements
- **Ocean Mode**: Further reduced curve lines height to 10% of original and renamed to "娴锋磱" (Ocean)
- **Localization**: Updated all translation files to use the new name "娴锋磱" for Ocean Wave mode
...
## [v2.0.5]
### 鉁?System Updates & Documentation
...
## [v1.9.69]
### 馃洜锔?System Integrity Fix & Audit
